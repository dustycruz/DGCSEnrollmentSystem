...
public class SectionService : ISectionService
{
    ...
    public async Task<IEnumerable<Section>> GetAllAsync()
        => await _sectionRepo.GetAllActiveAsync();

    public async Task<Section?> GetAsync(int id)
        => await _sectionRepo.GetByIdAsync(id);

    public async Task<Section?> GetWithSchedulesAsync(int id)
        => await _sectionRepo.GetWithSchedulesAsync(id);
    ...
    public async Task<ServiceResult> UpdateAsync(Section section, string modifiedBy)
    {
        ...
        if (existing is null)
            return ServiceResult.Fail("Section not found.");
    ...
    public async Task<ServiceResult<int>> AddScheduleAsync(Schedule schedule, string createdBy)
    {
